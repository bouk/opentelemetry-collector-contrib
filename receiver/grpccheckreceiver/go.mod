module github.com/open-telemetry/opentelemetry-collector-contrib/receiver/grpccheckreceiver
...
require (
	...
	go.opentelemetry.io/collector/extension/extensionauth/extensionauthtest v0.144.1-0.20260130192532-20cbfc09f93d // indirect
